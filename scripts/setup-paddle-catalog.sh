...
echo "NEXT_PUBLIC_PADDLE_ENVIRONMENT=sandbox"
echo "NEXT_PUBLIC_PADDLE_PRICE_BASICA_MONTH=${PRI_WEB_MO}"
echo "NEXT_PUBLIC_PADDLE_PRICE_BASICA_YEAR=${PRI_WEB_YR}"
echo "NEXT_PUBLIC_PADDLE_PRICE_SEO_MONTH=${PRI_SEO_MO}"
echo "NEXT_PUBLIC_PADDLE_PRICE_SEO_YEAR=${PRI_SEO_YR}"
echo "NEXT_PUBLIC_PADDLE_PRICE_AUTOMATIZAR_MONTH=${PRI_AUTO_MO}"
echo "NEXT_PUBLIC_PADDLE_PRICE_AUTOMATIZAR_YEAR=${PRI_AUTO_YR}"
echo
